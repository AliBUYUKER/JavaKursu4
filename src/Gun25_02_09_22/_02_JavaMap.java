...
public class _02_JavaMap {
    public static void main(String[] args) {
        // Set -> HastSet, linkedHasSet, TreeSet
        // Map -> HastMap, linkedHasMap, TreeMap
        
        // anahtarımın tipi ınteger, değerlerimin tipi String olacak
        HashMap<Integer,String> hm=new HashMap<>();
        hm.put(1001,"İsmet Temur");
        hm.put(1002,"Birkan Filiz");
        hm.put(2001,"Hasan Aşık");
        hm.put(5001,"Hatice");
        hm.put(2001,"Eyüpcan Bilgin");// 2001 deki bilgiyi Güncelliyor
